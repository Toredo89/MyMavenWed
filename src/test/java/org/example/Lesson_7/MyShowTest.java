...
import org.example.Lesson_7.AbstractTest;
...
public class MyShowTest extends AbstractTest {
    ...
    void testFalse() throws InterruptedException, IOException {
        Thread.sleep(1000);
        File file = MyUtils.makeScreenshot(getWebDriver(),"failure- org.example.Lesson_7.MyShowTest.testFalse" + System.currentTimeMillis() + ".png");
